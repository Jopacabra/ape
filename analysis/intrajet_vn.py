...
# Jet finding cuts
R = 1.0
pTmin_jet_finder = 3.0  # Minimum pT of constituents to consider
rap_min_jet_finder = 0.0  # Minimum rapidity of constituents to consider
rap_max_jet_finder = 100   # Maximum rapidity of constituents to consider
gamma_min_pt = 3.0  # Minimum pT of gamma trigger
...
refaxis = "jet"
event_type = "dijet"  # dijet or gammajet
...
for case in ["v", "m"]:
        ...
        try:
            ...
            try:
                if event_type == "gammajet":
                    ...
                    jets = observables.hepmc_to_fastjet(hepmc_event=event, R=R,
                                                        rap_min=rap_min_jet_finder,
                                                        rap_max=rap_max_jet_finder,
                                                        pTmin=pTmin_jet_finder,
                                                        scheme=fastjet.WTA_pt_scheme)
            ...
            for jet in jets:
                ...
                if len(jet.constituents()) < min_constituents:
                    h += 1
                    continue
    ...
    print(f"Number of no event {case} files: {no_pair}")
    ...
    print(f"Number of too few constituents {case} jets: {h}")
    ...
    for i, jet in enumerate(analyzed_jets):
        ...
        # Compute vns
        if refaxis == "jet" or event_type == "dijet":
    ...
    if cut_by == "pt" or event_type == "dijet":
        cut_bins = E_bins
